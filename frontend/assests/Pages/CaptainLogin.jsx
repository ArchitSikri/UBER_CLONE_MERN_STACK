      ...
      <div className="min-h-[calc(100vh-140px)] flex items-center justify-center">
        <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/5">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1.05fr_0.95fr] p-8 lg:p-10">
            <section className="rounded-3xl bg-orange-950 p-8 text-white shadow-xl shadow-slate-900/10 backdrop-blur-xl md:p-10">
              <div className="mb-6">
                <p className=" uppercase tracking-[0.35em] text-white text-3xl">Uber</p>
                <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">Welcome back Captain</h1>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-3xl bg-black   p-4 shadow-lg shadow-slate-900/30 ring-1 ring-white/10 transition hover:-translate-y-1 hover:bg-white/15">
            ...
            <section className="rounded-3xl bg-white p-8 shadow-xl shadow-slate-900/10 md:p-10">
              <div className="mb-8 text-center">
                ...
                <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900">Captain access</h2>
