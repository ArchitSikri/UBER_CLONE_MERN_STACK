  ...
  return (
    ...
    background-image: linear-gradient(var(--tw-gradient-stops)); from-cyan-500/20 via-sky-500/20 to-emerald-500/20 blur-3xl" />
          <div className="relative grid gap-8 p-6 sm:p-8 lg:grid-cols-[1.02fr_0.98fr] lg:p-10">
            <section className="rounded-[1.75rem] bg-slate-950 p-8 text-white shadow-xl shadow-slate-900/20 sm:p-10">
              <div className="mb-8">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-3xl bg-white/10 p-4 ring-1 ring-white/10 shadow-lg shadow-slate-900/20">
